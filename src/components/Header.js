...
const Header = ({ headerLogo, introText }) => {
  ...
  return (
    ...
    >
      <Box flex="1" display="flex" alignItems="center" justifyContent="center" flexDirection="column" px="3rem"  w={'100%'} >
        <Box mb={4}>
          <Text  fontSize={['0.7rem','0.8rem','0.8rem','1rem',"1.2rem","1.2rem"]}
          textAlign={'center'}
          >Elevate your business with cutting-edge AI solutions and SaaS products from our innovative software house.</Text>
        </Box>
        <Text
          fontSize={['1.2rem','1.5rem','2.4rem','3rem',"3.5rem","3.5rem"]}
        ...
        <Text
          fontSize={['0.9rem','1.1rem','1.5rem','2rem',"2.5rem","2.5rem"]}
          letterSpacing="-0.1rem"
          fontWeight="400"
          whiteSpace={"nowrap"}
          // textAlign="center"
...
Where Innovation Meets Software Excellence.
        ...
        flexDirection={['column',,'row',,,]}gap={4}>
          <Box
            display="flex"
            alignItems="center"
            // borderRadius="1rem"
